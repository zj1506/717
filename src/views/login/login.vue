            ...
            <div class="content">
                <ul class="int_list">
                    <li>
                        ...
                        <input type="text" placeholder="请输入您的手机号" v-model="login_phone">
                    </li>
                    <li>
                        <i class="icon iconfont icon-form"></i>
                        <input type="text" placeholder="请输入您的密码" v-model="login_pass">
                    </li>
                </ul>
                <div class="loadbtn">
                    <span @click="logined">立即登录</span>
                </div>
            </div>
        </div>
        <div class="register" v-else>
            ...
            <div class="content">
                <ul class="int_list">
                    <li>
                        <i class="icon iconfont icon-people"></i>
                        <input type="text" placeholder="请输入您的手机号" v-model.trim="phone_number">
                    </li>
                    <li class="certify">
                        <i class="icon iconfont icon-apps"></i>
                        <input type="text" placeholder="请输入验证码" v-model.trim="verify_code">
                        <span class="get_certify" @click="get_certify">获取验证码</span>
                    </li>
                    <li>
                        <i class="icon iconfont icon-form"></i>
